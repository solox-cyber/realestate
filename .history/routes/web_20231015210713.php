...
Route::get('/agents/{id}/edit', [DashboardController::class, 'edit'])->name('agents.edit');
Route::put('/agents/{id}', [DashboardController::class, 'update'])->name('agents.update');
Route::delete('/agents/{id}', [DashboardController::class, 'destroy'])->name('agents.destroy');
// });

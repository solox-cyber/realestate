...
Route::put('/agents/{id}', [DashboardController::class, 'agentupdate'])->name('agents.update');
Route::delete('/agents/{id}', [DashboardController::class, 'agentdestroy'])->name('agents.destroy');
// });

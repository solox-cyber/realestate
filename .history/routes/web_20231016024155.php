...
Route::get('/location/{id}/edit', [LocationController::class, 'locationedit'])->name('location.edit');
Route::put('/location/{id}', [LocationController::class, 'locationupdate'])->name('location.update');
Route::delete('/location/{id}', [LocationController::class, 'locationdestroy'])->name('location.destroy');

...
Route::post('/features/store', [DashboardController::class, 'featuresstore'])->name('features.store');
Route::get('/features/{features}/edit', [DashboardController::class, 'featuresedit'])->name('features.edit');
Route::put('/features/{id}', [DashboardController::class, 'featuresupdate'])->name('features.update');
Route::delete('/features/{features}', [DashboardController::class, 'featuresdestroy'])->name('features.destroy');
// });

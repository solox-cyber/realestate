...
Route::get('/location', [DashboardController::class, 'listinglist'])->name('listing.list');
Route::get('/location/new', [DashboardController::class, 'listingnew'])->name('listing.new');
// });

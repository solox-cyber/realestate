...
Route::get('/features', [DashboardController::class, 'featureslist'])->name('features.list');
Route::get('/features/new', [DashboardController::class, 'featuresnew'])->name('features.new');
Route::post('/features/store', [DashboardController::class, 'featuresstore'])->name('feature.store');
Route::get('/features/{features}/edit', [DashboardController::class, 'featuresedit'])->name('feature.edit');
Route::put('/features/{id}', [DashboardController::class, 'featuresupdate'])->name('features.update');
Route::delete('/features/{features}', [DashboardController::class, 'featuresdestroy'])->name('feature.destroy');
Route::get('/feature/{id}/edit', 'FeatureController@edit')->name('feature.edit');

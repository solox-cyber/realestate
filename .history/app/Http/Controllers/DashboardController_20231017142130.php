...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $listingsForSaleCountPercent = rount($listingsForSaleCount / $totalListings) *100;
        $listingsForRentCountPercent = ($listingsForRentCount / $totalListings) *100;
        return view('admin.dashboard', compact('difference','totalListings','listingsForSaleCount','listingsForRentCount',
        'listingsForSaleCountPercent','listingsForRentCountPercent'));
    }

                                ...
                                <div class="row p-lg-5">
                                    ...
                                    <div class="input-group custom_file_input col-md-9 mb-3">
                                        <div class="form-file">
                                          ...
                                          <input type="text" name="video" class="form-file-input form-control">
                                        </div>
                                        <span class="input-group-text">Property Video Link</span>
                                    </div>
                                    <hr class="mt-4">
                                    ...
                                    <div class="input-group custom_file_input col-md-9 mb-3">
                                        <div class="form-file">
                                            <input type="file" name="image_plan" class="form-file-input form-control">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            Rooms
                                            <input type="text" name="main_rooms" class="form-control " value="{{ old('main_rooms') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            Bath
                                            <input type="text" name="main_bath" class="form-control " value="{{ old('main_bath') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            Size (Sqft)
                                            <input type="text" name="main_size" class="form-control " value="{{ old('main_size') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">

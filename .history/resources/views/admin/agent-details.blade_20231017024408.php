                        ...
                        <div class="basic-form ">
                            ...
                            <form action="{{route('agent.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row p-lg-5">
                                    ...
                                    <div class="input-group custom_file_input col-md-12 mb-3">

                                        <div class="form-file">
                                            <input type="file" name="image" class="form-file-input form-control">
                                        </div>
                                        <span class="input-group-text">Upload Agent Picture</span>

                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Name
                                            <input type="text" name="name" class="form-control input-default" value="{{ old('name') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Email
                                            <input type="email" name="email" class="form-control input-default" value="{{ old('email') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">

                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                @if($feature->listingImage->first())
                                                @if($feature->listingImage->first()->path)
                                                <img src="{{ asset('images/listings/'.$feature->listingImage->first()->path) }}" class="rounded-lg me-2" width="24" alt="" />
                                                {{ asset('images/listings/'.$feature->listingImage->first()->path) }}
                                                @else
                                                No Image Available
                                                @endif
                                                @endif

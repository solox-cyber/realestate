...
<div class="content-body">
    ...
    <canvas id="chartBar"></canvas>
        ...
        <p class="mb-2 d-flex align-items-center  fs-16 text-black font-w500">{{$location->town}} totalListings
            <span class="pull-right text-dark fs-14 ms-2">{{ $location->listings_count }} Unit</span>
        </p>
        <div class="progress mb-4" style="height:10px">
            <div class="progress-bar bg-primary progress-animated" style="width:{{ ($location->listings_count/) * 100 }}%; height:10px;" role="progressbar">

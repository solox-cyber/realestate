                            ...
                            <form action="{{route('feature.store')}}" method="post">
                                ...
                                <div class="row p-lg-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            Rooms
                                            <input type="text" name="bathrooms" class="form-control " value="{{ old('ground_rooms') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            Bath
                                            <input type="text" name="bathrooms" class="form-control " value="{{ old('ground_bath') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            Size
                                            <input type="text" name="bathrooms" class="form-control " value="{{ old('ground_size') }}" placeholder="">
                                        </div>
                                    </div>

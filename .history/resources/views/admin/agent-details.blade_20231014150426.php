                        ...
                        <div class="basic-form row">
                            <form action="{{route('agent.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        Name
                                        <input type="text" name="name" class="form-control col-md-6 input-default" placeholder="input-default">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        Email
                                        <input type="email" name="email" class="form-control col-md-6 input-default" placeholder="input-default">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">

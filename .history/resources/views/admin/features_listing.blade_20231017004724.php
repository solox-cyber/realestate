            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="{{route('feature.new')}}">Add New</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                @if($feature->image)
                                                <img src="{{ asset('images/agents/'.$feature->image) }}" class="rounded-lg me-2" width="24" alt="" />
                                                @endif
                                                <span class="w-space-no">{{ $feature->name }}</span>
                                            </div>
                                        </td>
                                        <td>{{ $feature->address }}</td>
                                        <td>{{$feature->agent->name}}</td>
                                        <td>{{ $feature->cost }}</td>

                            ...
                            <form action="{{route('agent.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row p-lg-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Email
                                            <input type="email" name="email" class="form-control input-default" value="{{ old('email') }}" placeholder="input-default">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Telephone
                                            <input type="text" name="telephone" class="form-control input-default" value="{{ old('telephone') }}" placeholder="input-default">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <!-- Add input fields for baths, bedrooms, rooms, kitchens, living rooms, area (sqft), year built, garages, bathrooms, and plot size here -->

                            ...
                            <table class="table table-responsive-md">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>01 August 2020</td>
                                        <td>
                                            <div class="d-flex align-items-center"><i class="fas fa-circle text-danger me-1"></i> Canceled</div>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="#" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                    ...
                                    <tr>
                                        ...
                                        <td>01 August 2020</td>
                                        <td>
                                            <div class="d-flex align-items-center"><i class="fas fa-circle text-warning me-1"></i> Pending</div>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="#" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>

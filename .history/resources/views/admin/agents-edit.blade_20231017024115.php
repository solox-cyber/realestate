                            ...
                            <form action="{{ route('agents.update', ['id' => $agent->id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row p-lg-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Email
                                            <input type="email" name="email" class="form-control input-default" value="{{ $agent->email }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Telephone
                                            <input type="text" name="telephone" class="form-control input-default" value="{{ $agent->telephone }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Address
                                            <input type="text" name="address" class="form-control input-default" value="{{ $agent->address }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">

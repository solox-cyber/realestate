                ...
                <div class="card">
                    ...
                    <div class="card-body p-10">
                        <div class="basic-form ">
                            ...
                            <form action="{{ route('agent.store', ['id' => $agent->id]) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row p-lg-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Name
                                            <input type="text" name="name" class="form-control input-default" value="{{ $agent->name }}" placeholder="input-default">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">

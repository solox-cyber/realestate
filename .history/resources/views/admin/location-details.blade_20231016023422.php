                            ...
                            <form action="{{route('location.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row p-lg-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            Community Name
                                            <input type="text" name="community" class="form-control input-default" value="{{ old('community') }}" placeholder="input-default">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
...
<script>
  ...
  Lagos: ["Agege", "Lagos", "Ikeja", "Lekki", "Ojo", "Badagry", "Epe", "Mushin", "Ikorodu"],

(function ($) {
    ...
    $(document).ready(function () {
         ...
         */
        let body = 'body';
        let feedback_modal = '#ulisting-feedback-modal';

        $(body).on('click', '.ulisting-feedback-button', function (e) {
            e.preventDefault();
        ...
        $(body).on('click', function ( e ) {
            if ( e.target.id === 'ulisting-feedback-modal' ) {
                $(feedback_modal).fadeOut(200);
            }
        });
        ...
        $(body).on('click', '.feedback-submit', function (e) {
            ...
            $.ajax({
                url: ajaxurl,
                type: 'GET',
                data: 'action=stm_ulisting_ajax_add_feedback',
                success: function (data) {
                    $('.ulisting-feedback-button').remove();
                }
            });
        });
